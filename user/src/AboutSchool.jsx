            ...
            <ScrollReveal>
                <div className="flex flex-col md:block">
                    ...
                    <div
                        ...
                        style={{
                            backgroundImage:
                                "url('/imgs/310241947-586932963121590-3034296582378048999-n-16802426955401349567464.jpg')",
                        }}
                    >
                    ...
                    <div className="md:hidden px-4 py-6 sm:py-8 bg-[#F5F5F5]">
                        <div className="max-w-6xl mx-auto">
                            ...
                            <p className="text-sm sm:text-base text-gray-700">
                                Được thành lập vào năm 2000, với mục tiêu cung
                                cấp giáo dục chất lượng và môi trường học tập
                                hiện đại. Trải qua nhiều năm phát triển, trường
                                đã đạt được nhiều thành tích xuất sắc trong
                                giảng dạy và hoạt động ngoại khóa, trở thành một
                                trong những trường THPT uy tín trong khu vực.
                            </p>
                        </div>
                    </div>
                </div>
                            ...
                            <div className="lg:w-2/3 bg-[#F6F6F6] p-8 rounded-lg relative">
                                <div className="lg:w-3/4">
                                    ...
                                    <p className="text-gray-700 leading-relaxed">
                                        Trường chú trọng không chỉ kiến thức mà
                                        còn phát triển kỹ năng sống, tư duy sáng
                                        tạo và tinh thần tự lập. Học sinh tham
                                        gia nhiều hoạt động ngoại khóa từ thể
                                        thao đến nghệ thuật, cùng các câu lạc bộ
                                        giúp rèn luyện sự tự tin và sáng tạo.
                                    </p>
                        ...
                        <div className="flex flex-col lg:flex-row-reverse items-center">
                            <div className="lg:w-2/3 bg-[#F6F6F6] p-8 rounded-lg relative">
                                <div className="lg:w-3/4 ml-auto">
                                    ...
                                    <p className="text-gray-700 leading-relaxed">
                                        Cơ sở vật chất hiện đại, với phòng học
                                        thông minh, thư viện phong phú và các
                                        phòng thí nghiệm chuyên dụng, tạo điều
                                        kiện thuận lợi nhất để học sinh khám phá
                                        tri thức và phát triển năng lực bản thân
                                        của mỗi học sinh.
                                    </p>
                                    <div className="w-16 h-1 bg-blue-700 mt-6"></div>
                                </div>
                    ...
                    <div className="max-w-7xl mx-auto mt-12 relative">
                        ...
                        <div className="space-y-12">
                            <div className="flex flex-col md:flex-row gap-4">
                                <div className="w-full md:w-1/2 flex items-center">
                                    <div>
                                        <h3 className="font-semibold text-lg text-gray-800">
                                            Giải trong kỳ thi học sinh giỏi cấp
                                            thành phố:
                                        </h3>
                                        <p className="text-gray-700">
                                            Nhiều học sinh của trường đã đạt các
                                            giải cao trong các kỳ thi học sinh
                                            giỏi các môn học, khẳng định chất
                                ...
                                <img
                                    src={achievement1}
                                    alt="Lễ khai mạc kỳ thi chọn học sinh giỏi quốc gia"
                            ...
                            <div className="flex flex-col md:flex-row gap-4 bg-[#F5F5F5] p-4 rounded-lg">
                                <img
                                    src={achievement2}
                                    alt="Lễ tuyên dương học sinh đoạt giải Olympic quốc tế"
                                ...
                                <div className="w-full md:w-1/2 flex items-center">
                                    <div>
                                        ...
                                        <p className="text-gray-700">
                                            Học sinh của trường đã tham gia và
                                            giành nhiều giải thưởng trong các
                                            cuộc thi Olympic quốc gia về Toán,
                                            Vật lý, Hóa học và Tiếng Anh.
                                        </p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="flex flex-col md:flex-row gap-4">
                                <div className="w-full md:w-1/2 flex items-center">
                                    <div>
                                        <h3 className="font-semibold text-lg text-gray-800">
                                            Đạt học bổng tại trường đại học danh
                                            tiếng:
                                        </h3>
                                        <p className="text-gray-700">
                                            Nhiều cựu học sinh của trường đã
                                            nhận được học bổng từ các trường đại
                            ...
                            <div className="flex flex-col md:flex-row gap-4 bg-[#F5F5F5] p-4 rounded-lg">
                                ...
                                <div className="w-full md:w-1/2 flex items-center">
                                    <div>
                                        <h3 className="font-semibold text-lg text-gray-800">
                                            Thành tích xuất sắc các cuộc thi thể
                                            thao:
                                        </h3>
                                        <p className="text-gray-700">
                                            Đội tuyển thể thao của trường đã
                                            giành nhiều huy chương vàng tại các
                                            giải đấu thể thao cấp thành phố và
                                            quốc gia.
                                        </p>
                                    </div>
                                </div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                            ...
                            <div className="bg-white rounded-lg shadow-md overflow-hidden">
                                ...
                                <div className="p-4">
                                    ...
                                    <p className="text-sm text-gray-500 mt-2">
                                        Thầy đã từng giúp nhiều học sinh vượt
                                        qua nỗi sợ môn toán bằng phương pháp
                                        giảng dạy của thầy
                                    </p>
                                    <p className="text-[#FF7426] font-semibold mt-2">
                                        Hiệu trưởng
                                    </p>
                                </div>
                            </div>
                            ...
                            <div className="bg-white rounded-lg shadow-md overflow-hidden">
                                ...
                                <div className="p-4">
                                    ...
                                    <p className="text-sm text-gray-500 mt-2">
                                        Cách giảng dạy của cô đã biến một môn cố
                                        vể "khô khan" sang một môn học trần đầy
                                        thú vị
                                    </p>
                                    <p className="text-[#FF7426] font-semibold mt-2">
                                        Phó hiệu trưởng
                            ...
                            <div className="bg-white rounded-lg shadow-md overflow-hidden">
                                ...
                                <div className="p-4">
                                    ...
                                    <p className="text-sm text-gray-500 mt-2">
                                        Là một giáo viên có thành tích 9.0 Ietls
                                        và đạt được nhiều thành tích cao và cách
                                        dạy rất thu hút học sinh
                                    </p>
                                    <p className="text-[#FF7426] font-semibold mt-2">
                                        Phó hiệu trưởng
                                    </p>
