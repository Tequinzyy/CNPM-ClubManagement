...
const NewsDetail = () => {
    ...
    const newsItems = [
        {
            ...
            date: "3/10/2024",
            description:
                "Chiều ngày 3/10/2024 tại Thành Phố Hồ Chí Minh, Trường THPT TPHCM đã tổ chức lễ ra mắt chương trình Luyện thi IELTS mới,...",
      ...
      Nhà trường còn lên kế hoạch tổ chức các hoạt động ngoại khóa sau giờ học, tạo điều kiện để học sinh thư giãn và gắn kết với bạn bè sau thời gian dài học trực tuyến.`,
        },
        {
            ...
            date: "3/10/2024",
            description:
                "Chủ trương đưa tiếng Anh làm ngôn ngữ thứ hai gần đây là một bước tiến lớn nhằm giúp người học thành công trong cuộc sống và công việc.",
      ...
      Việc áp dụng công nghệ này còn mở ra cơ hội để các bảo tàng tương tác với cộng đồng và học sinh, giúp thế hệ trẻ hiểu thêm về di sản văn hóa của đất nước.`,
        },
        {
            ...
            date: "5/10/2024",
            description:
                "Phù hợp với các Mục tiêu phát triển bền vững, 95,7% trong số đó đã tích hợp tính bền vững vào tài liệu giảng dạy và học tập.",
      ...
      Bà Trần Thu Hà, trưởng ban cố vấn học bổng, cho biết: "Chúng tôi hy vọng chương trình học bổng sẽ giúp đỡ nhiều em học sinh có điều kiện học tập tốt hơn. Đây cũng là cách chúng tôi đóng góp cho cộng đồng."`,
        },
        {
            ...
            date: "15/10/2024",
            description:
                "Cuộc thi sáng tạo khoa học kỹ thuật cấp quốc gia năm nay thu hút hơn 2.000 học sinh từ khắp cả nước với những dự án đầy sáng tạo và tiềm năng.",
      ...
      Đây là cơ hội quý báu để học sinh phát huy khả năng sáng tạo và ứng dụng kiến thức vào thực tế.`,
        },
        {
            ...
            date: "20/10/2024",
            description:
                "Nhóm sinh viên đại học X đã giành chiến thắng trong cuộc thi công nghệ quốc tế với dự án sử dụng trí tuệ nhân tạo trong y tế.",
    ...
    return (
        <div className="max-w-7xl mx-auto p-4">
            <h1 className="text-2xl font-bold text-[#004D86] mb-4 text-center">
                {news.title}
            </h1>
            <img
                src={news.image}
