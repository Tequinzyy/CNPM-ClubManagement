...
const CooperationItem = ({ title, date, content, imageUrl, id }) => (
    <Link
        to={`/international-cooperation/${id}`}
        className="flex flex-col md:flex-row mb-8 pb-8 border-b border-gray-200 no-underline"
    >
        <img
            src={imageUrl}
            alt={title}
        ...
        <div className="flex-1 space-y-2 md:space-y-4">
            <h3 className="text-[#000000] text-lg md:text-xl font-semibold mt-0">
                {title}
            </h3>
            ...
            <p className="text-gray-800 text-sm md:text-base line-clamp-3 md:line-clamp-4">
                {content}
            </p>
        </div>
    </Link>
...
const InternationalCooperation = () => {
    const allCooperationItems = [
        // Existing articles with ids
        {
            ...
            date: "05/09/2024",
            content:
                "Trong những ngày 17/09/2024, 18/09/2024 và 21/09/2024, Trường đã tổ chức chương trình giao lưu với học sinh trường Raffles (Singapore). Để đảm bảo an toàn sau hậu quả của thiên tai, chương trình giao lưu được thực hiện qua hình thức trực tuyến trên Microsoft Teams.",
        ...
        },
        {
            ...
            date: "20/07/2024",
            content:
                "Đến với trường, các bạn học sinh Nhật Bản từ trường Miyazaki đã có cơ hội được trải nghiệm tại phòng thí nghiệm Nông nghiệp ĐHCN Quốc gia. Buổi trải nghiệm cùng thành viên CLB Khoa học (SPC) đã đem đến nhiều kiến thức bổ ích, thú vị cho các bạn học sinh Nhật Bản.",
        ...
        },
        {
            ...
            date: "15/06/2024",
            content:
                "Chiều thứ năm (26/10/2023) vừa qua, đoàn học sinh trường Frederiksborg đã có một buổi trải nghiệm STEM do CLB Khoa học (SPC - Science Passion Club) tổ chức. Thành viên trong CLB đã đem đến những thí nghiệm sáng tạo, độc đáo, để lại ấn tượng sâu sắc cho những người bạn Đan Mạch.",
