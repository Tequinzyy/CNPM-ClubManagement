  ...
  Chuyến đi sẽ không chỉ mang lại kiến thức bổ ích mà còn giúp các em tạo dựng những kỷ niệm đẹp đẽ và sâu sắc. Sau chuyến đi, các em sẽ viết lại nhật ký hành trình và chia sẻ tại buổi tổng kết, ghi dấu những trải nghiệm ý nghĩa đã có.`,
    ...
    return (
        <div className="max-w-6xl mx-auto p-6 font-sans">
            <h1 className="text-4xl font-bold text-[#004D86] mb-4 text-center">
                {article.title}
            </h1>
            <img
            ...
            <Link
                ...
                className="bg-yellow-400 text-black py-3 px-8 rounded text-lg font-semibold block mx-auto hover:bg-yellow-500 transition duration-300"
            >
                Quay lại
            </Link>
        </div>
