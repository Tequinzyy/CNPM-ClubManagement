...
const Homepage = () => {
    ...
    const newsItems = [
        ...
        },
        {
            ...
            date: "12/10/2024",
            description:
                "Trường phát động chương trình học bổng cho học sinh có hoàn cảnh khó khăn, nhằm hỗ trợ những em có thành tích học tập tốt nhưng gặp khó khăn về tài chính, giúp các em có cơ hội tiếp cận giáo dục chất lượng hơn.",
        },
        {
            ...
            date: "18/10/2024",
            description:
                "Học sinh tham gia cuộc thi sáng tạo với nhiều dự án ấn tượng, thể hiện sự sáng tạo và kỹ năng giải quyết vấn đề. Các dự án được đánh giá cao về tính khả thi và ý nghĩa thực tiễn trong đời sống hàng ngày.",
        },
        {
    ...
    return (
        <div>
            ...
            >
                <img
                    src="/imgs/banner.jpg"
                    alt="Trường trung học phổ thông"
                    className="w-full object-cover h-[300px] sm:h-[400px] md:h-[500px]"
                />
                <div
                    className="absolute bottom-0 left-1/2 transform -translate-x-1/2 p-4 sm:p-6 border-t-4 border-black w-11/12 sm:w-5/6 md:w-4/6"
                    style={{
                ...
                >
                    <div className="text-left">
                        ...
                        <h1 className="text-white text-xl sm:text-2xl md:text-4xl font-bold mb-2 sm:mb-3">
                            Trường trung học phổ thông
                        </h1>
                        <p className="text-white text-xs sm:text-sm md:text-base">
                            Mang lại trải nghiệm học tập tốt nhất cho bạn, trau
                            dồi kỹ năng học hỏi và kết bạn, đồng thời tạo ra môi
                            trường thân thiện, giúp bạn phát triển bản thân một
                            cách toàn diện.
                        </p>
                    </div>
                </div>
            ...
            <ScrollReveal>
                <div className="max-w-3xl mx-auto mt-8 px-4">
                    <h2 className="text-xl sm:text-2xl font-bold text-center mb-4 text-[#004D86]">
                        Tìm kiếm
                    </h2>
                    <div className="flex flex-col items-center">
                        ...
                        <div className="flex flex-wrap justify-center mt-4 gap-2">
                            <button
                                className="px-4 py-2 border border-[#004D86] rounded-full text-[#004D86] hover:bg-[#004D86] hover:text-white transition duration-300"
                    ...
                    <div className="max-w-6xl mx-auto">
                        ...
                        <div className="hidden lg:flex h-[25rem] pt-1">
                            ...
                            <div className="w-1/2 h-auto relative">
                                ...
                                <div className="absolute top-0 left-0 w-full h-full">
                                    <p className="text-sm absolute top-[4%] left-[24%]">
                                        Chú trọng phát triển năng lực cá nhân,
                                        nhấn mạnh việc{" "}
                                        <b>
                                            rèn luyện kĩ năng bồi đắp phẩm chất
                                        </b>
                                    </p>
                                    <p className="text-sm absolute top-[25%] left-[36%]">
                                        Cách tiếp cận học tập chủ động thông qua{" "}
                                        <b>trải nghiệm, suy ngẫm</b>
                                    </p>
                                    <p className="text-sm absolute top-[44%] left-[25%]">
                                        Tập trung{" "}
                                        <b>phát triển tư duy bậc cao</b> cho học
                                        sinh như phân tích, đánh giá, sáng tạo
                                    </p>
                                    <p className="text-sm absolute top-[63%] left-[36%]">
                                        Giúp học sinh vừa{" "}
                                        <b>hội nhập toàn cầu</b>, vừa{" "}
                                        <b>
                                            giữ gìn và phát huy bản sắc Việt Nam
                                        </b>
                                    </p>
                                    <p className="text-sm absolute top-[85%] left-[24%]">
                                        Học sinh có thể{" "}
                                        <b>học mọi lúc mọi nơi</b>, kết hợp giữa
                                        việc tự học thông qua nền tảng công nghệ
                                        và học tập chuyên sâu tại lớp
                                    </p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="lg:hidden space-y-4 sm:space-y-6">
                            ...
                            >
                                ...
                                <p className="text-sm">
                                    Chú trọng phát triển năng lực cá nhân, nhấn
                                    mạnh việc rèn luyện kĩ năng – bồi đắp phẩm
                                    chất
                                </p>
                            </motion.div>
                            <motion.div
                            ...
                            >
                                ...
                                <p className="text-sm">
                                    Tập trung phát triển tư duy bậc cao cho học
                                    sinh như phân tích, đánh giá, sáng tạo
                                </p>
                            </motion.div>
                            <motion.div
                            ...
                            >
                                ...
                                <p className="text-sm">
                                    Giúp học sinh vừa hội nhập toàn cầu, vừa giữ
                                    gìn và phát huy bản sắc Việt Nam
                                </p>
                            </motion.div>
                            <motion.div
                                variants={fadeIn}
                            ...
                            >
                                ...
                                <p className="text-sm">
                                    Học sinh có thể học mọi lúc mọi nơi, kết hợp
                                    giữa việc tự học thông qua nền tảng công
                                    nghệ và học tập chuyên sâu tại lớp
                                </p>
                            </motion.div>
                        </div>
                    </div>
                    ...
                    <div className="max-w-6xl mx-auto">
                        ...
                        <div className="flex flex-col md:flex-row justify-between items-center space-y-8 md:space-y-0 md:space-x-4">
                            <div className="flex flex-col items-center text-center max-w-xs mt-6">
                                <img
                                    src="/imgs/icon-achievement-1.png"
                                    alt="Global Education"
                                    className="w-20 h-auto mb-4"
                                />
                                <p className="text-sm text-gray-600">
                                    Trường học kết hợp phương pháp giảng dạy mới
                                    nhất mang lại kết quả tốt nht
                                </p>
                            </div>
                            <div className="flex flex-col items-center text-center max-w-xs">
                                <img
                                    src="/imgs/icon-achievement-2.png"
                                    alt="30 Years Experience"
                                    className="w-20 h-25 mb-4"
                                />
                                <p className="text-sm text-gray-600">
                                    Kinh nghiệm 30 năm giảng dạy chuyên ngành
                                    bằng ngoại ngữ
                                </p>
                            </div>
                            <div className="flex flex-col items-center text-center max-w-xs">
                                <img
                                    src="/imgs/icon-achievement-3.png"
                                    alt="Education Quality"
                                    className="w-20 h-25 mb-4"
                                />
                                <p className="text-sm text-gray-600">
                                    Đạt kiểm định chất lượng giáo dục về chương
                                    trình đào tạo và cơ sở giáo dục
                                </p>
                            </div>
                        </div>
                    </div>
                        ...
                        <div className="max-w-6xl mx-auto relative z-10 w-full pb-[7rem] px-4 md:px-2">
                            <div className="md:w-2/3 lg:w-1/2">
                                ...
                                <p className="text-md text-white">
                                    Có rất nhiều hoạt động và dịch vụ hỗ trợ các
                                    bạn học sinh lên kế hoạch và đưa ra các
                                    quyết định về nghề nghiệp, cũng như tìm được
                                    ngành nghề phù hợp sau khi tốt nghiệp. Chuẩn
                                    bị cho việc hướng nghiệp, Kế hoạch và Quyết
                                    định nghề nghiệp, Các Chương trình và Sự
                                    kiện Hướng nghiệp.
                                </p>
                            </div>
                        </div>
                ...
                <div className="md:hidden px-4 py-6 sm:py-8 bg-[#F5F5F5]">
                    <div className="max-w-6xl mx-auto">
                        ...
                        <p className="text-sm sm:text-base text-gray-700">
                            Có rất nhiều hoạt động và dịch vụ hỗ trợ các bạn học
                            sinh lên kế hoạch và đưa ra các quyết định về nghề
                            nghiệp, cũng như tìm được ngành nghề phù hợp sau khi
                            tốt nghiệp. Chuẩn bị cho việc hướng nghiệp, Kế hoạch
                            và Quyết định nghề nghiệp, Các Chương trình và Sự
                            kiện Hướng nghiệp.
                        </p>
                    </div>
                </div>
